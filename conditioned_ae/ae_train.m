function [args]=ae_train(args)
    ...
    for i1=1:args.maxecho
        waitbar(0,h,strcat('��',num2str(i1),'/',num2str(args.maxecho),'�ֵ��'));
        for i2=1:args.circletimes
            ...
            waitbar(i2/args.circletimes,h,strcat('��',num2str(i1),'/',num2str(args.maxecho),'�ֵ��',num2str(i2),'/',num2str(args.circletimes)));
        end
