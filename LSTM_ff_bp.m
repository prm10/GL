function [adw]=LSTM_ff_bp(args,input,label)
    %% 前向传播
    % encoder
    ...
    [x2,in2,f2,z2,c2,o2,y2,reconstruct]=LSTM_step_ff1(input_x11,C2,C1,args.WeightDecoder,args.LengthDecoder);
    % predict
    ...
    [delta_up3,delta_c03,adw.WeightPredict]=...
        LSTM_step_bp1(args,label,predict,args.WeightPredict,args.Mom.WeightPredict,x3,in3,f3,z3,c3,o3,y3,C3);
    [delta_up2,delta_c02,adw.WeightDecoder]=...
        LSTM_step_bp1(args,input(size(input,1):-1:size(input,1)-args.LengthDecoder+1,:),reconstruct,args.WeightDecoder,args.Mom.WeightDecoder,x2,in2,f2,z2,c2,o2,y2,C2);
    %encoder layer
...
%         args.WeightTranR{i1}.b_k=args.WeightTranR{i1}.b_k-args.learningrate*args.Mom.WeightTranR{i1}.b_k;
    ...
    adw.WeightEncoder{length(args.encoderLayer)-1}.w_k=dw_k1;
    adw.WeightEncoder{length(args.encoderLayer)-1}.b_k=db_k1;
...
%     args.WeightEncoder{end}.b_k=b_k1-args.learningrate*args.Mom.WeightEncoder{end}.b_k;
    ...
    for i1=length(args.encoderLayer)-2:-1:1
        [delta_up1,MomWeightEncoder]=LSTM_step_bp(args,delta_up1,args.WeightEncoder{i1},args.Mom.WeightEncoder{i1},x1{i1},in1{i1},f1{i1},z1{i1},c1{i1},o1{i1},y1{i1});
%         args.WeightEncoder{i1}=WeightEncoder;
        adw.WeightEncoder{i1}=MomWeightEncoder;
    end
